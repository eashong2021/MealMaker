const menu = {
    ...
    set appetizers(appetizers) {
     this._courses.appetizers = appetizerx;
    },
    set mains(mains) {
      this._mains = mains;
    },
    ...
    return dishes[randomIndex];
      ...
      const main = this.getRandomDishFromCourse('appetizers');
    ...
    menu.addDishToCourse('appetizers', 'coffee', 4.50);
    menu.addDishToCourse('appetizers', 'fries', 5.00);
    
    menu.addDishToCourse('mains', 'steak', 10.75);
